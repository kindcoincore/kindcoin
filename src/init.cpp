...
// Copyright (c) 2023-2026 The Kindcoin Developers
 ...
 * between kindcoind, and kindcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kindcoincore/kindcoin>";
    const std::string URL_WEBSITE = "<https://kindcoin.cc/>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Kindcoin More version %s\n", FormatFullVersion());
}
